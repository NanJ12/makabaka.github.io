    ...
    if (!e.jQuery) {
            ...
            for ("boolean" == typeof i && (u = i, i = arguments[s] || {}, s++), "object" != typeof i && "function" !== $.type(i) && (i = {}), s === l && (i = this, s--); l > s; s++)
                if (null != (n = arguments[s]))
                    for (a in n)
                        e = i[a],
                        r = n[a],
                        i !== r && (u && r && ($.isPlainObject(r) || (t = $.isArray(r))) ? (t ? (t = !1, o = e && $.isArray(e) ? e : []) : o = e && $.isPlainObject(e) ? e : {}, i[a] = $.extend(u, o, r)) : void 0 !== r && (i[a] = r));
            return i
        },
        ...
        $.dequeue = function(e, t) {
            $.each(e.nodeType ? [e] : e, function(e, r) {
                ...
                n && ("fx" === t && a.unshift("inprogress"), n.call(r, function() {
                    $.dequeue(r, t)
                }))
            })
        },
                    ...
                    if (v.State.calls[r]) {
                        ...
                        for (var d = Math.min((t - u) / l.duration, 1), m = 0, y = s.length; y > m; m++) {
                            ...
                            if (i(b)) {
                                ...
                                l.mobileHA && i(b).transformCache.translate3d === a && (i(b).transformCache.translate3d = "(0px, 0px, 0px)", S = !0),
                    ...
                    if ("scroll" === A) {
                        ...
                        for (var O in b) {
                            ...
                            if (i(o).isSVG || x.Names.prefixCheck(B)[1] !== !1 || x.Normalizations.registered[B] !== a) {
                                ...
                                s._cacheValues && j && j[O] ? (I === a && (I = j[O].endValue + j[O].unitType), W = i(o).rootPropertyValueCache[B]) : x.Hooks.registered[O] ? I === a ? (W = x.getPropertyValue(o, B), I = x.getPropertyValue(o, O, W)) : W = x.Hooks.templates[B][1] : I === a && (I = x.getPropertyValue(o, O));
                                var G,
                                    D,
                                    X,
                                    Y = !1;
                    ...
                    if (!$.isPlainObject(b) || g.isEmptyObject(b)) {
                        if (g.isString(b) && v.Redirects[b]) {
                            ...
                            return E.backwards === !0 && (h = $.extend(!0, [], h).reverse()), $.each(h, function(e, t) {
                                ...
                                E.drag && (E.duration = parseFloat(j) || (/^(callout|transition)/.test(b) ? 1e3 : y), E.duration = Math.max(E.duration * (E.backwards ? 1 - e / w : (e + 1) / w), .75 * E.duration, 200)),
